...
model = dict(
    ...
    mlp=True,
    aux_info=[],
    aug=dict(type="SyncMoCoAugmentV2", crop_size=image_shape[0], sync_level='batch', t=num_frames), )
...
pkl_path = 's3://activity-public/kinetics600/annos/kinetics400_new_train.pkl'
pkl_path_val = 's3://activity-public/kinetics600/annos/kinetics400_new_val.pkl'
img_norm_cfg = dict(
...
work_dir = './work_dirs/ssl_train/moco_consistent_vid_k400_lr3e-2'
checkpoint_config = dict(interval=10)
log_config = dict(
    interval=20,
    hooks=[
        dict(type='TextLoggerHook'),
        dict(type='TensorboardLoggerHook', log_dir="/data/mmaction2/tf_logs/ssl_train/moco_consistent_vid_k400_lr3e-2"),
    ])
