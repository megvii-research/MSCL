...
def extract_dense_flow(cur_pkl_path,
                       ...
                       dest_nori,
                       dest_meta,
                       gap=3, init_adjacent=4, num_flow=16,
                       fetcher=None):
    ...
    # TODO: -> {worker_id}_{part_id}.nori/Save this to part pkl
    ...
    dataset = SimpleDataset(cur_pkl_path, worker_num, worker_id, 
...
if __name__ == '__main__':
    ...
    dest = osp.join("s3://activity-public", args.dataset, f"flow_{args.method}ssr")
