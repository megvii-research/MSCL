...
from ..core import (DistEvalHook, EvalHook, SimpleDistEvalHook,
...
def train_model(model,
    ...
    if validate:
        ...
        if eval_cfg.pop('simple', False):
            assert distributed, "Simple evaluation not support non-distributed now!"
            eval_hook = SimpleDistEvalHook(val_dataloader, **eval_cfg)
        else:
